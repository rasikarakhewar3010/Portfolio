    ...
    if (status === "success") {
        return (
            <FloatingIconsHero icons={demoIcons} className="min-h-[800px]">
                <div id="contact" className="bg-white/40 backdrop-blur-xl border border-white/50 rounded-2xl p-8 md:p-12 shadow-2xl max-w-2xl mx-auto relative z-20 text-center">
                    <div className="mb-6">
                        ...
                        <Button
                            onClick={() => setStatus("")}
                            variant="outline"
                            className="bg-white hover:bg-gray-50 text-[#0f172a]"
                        >
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 rounded-lg border border-gray-200 bg-white/60 focus:outline-none focus:ring-2 focus:ring-[#f7bea7] focus:border-transparent transition-all text-sm disabled:opacity-50"
                    ...
                    <div className="space-y-1.5">
                        ...
                        <textarea
                            ...
                            required
                            disabled={status === "submitting"}
                            className="w-full px-3 py-2 rounded-lg border border-gray-200 bg-white/60 focus:outline-none focus:ring-2 focus:ring-[#f7bea7] focus:border-transparent transition-all resize-none text-sm disabled:opacity-50"
                    ...
                    <div className="pt-2">
                        <Button
                            ...
                            size="lg"
                            disabled={status === "submitting"}
                            className="w-full px-6 py-5 text-base bg-[#0f172a] hover:bg-[#1e293b] text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 disabled:opacity-70 disabled:hover:translate-y-0"
                        >
                            {status === "submitting" ? (
                        ...
                        {status === "error" && (
                            <p className="text-red-500 text-sm index-center mt-2">Oops! There was a problem submitting your form.</p>
                        )}
                    </div>
                </form>
            </div>
